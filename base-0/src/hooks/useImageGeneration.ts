...
// Dynamic prompt builder based on product and context - COMMENTED OUT
/*
...
export function useImageGeneration() {
  ...
  const generateImage = useCallback(async (
    ...
    try {
      ...
      // Use the user prompt directly without system prompt enhancement
      const enhancedPrompt = prompt;
      
      /*
      // COMMENTED OUT: Build dynamic UGC prompt based on product and context
      ...
      */
      ...
      console.log('Using direct user prompt:', enhancedPrompt);
